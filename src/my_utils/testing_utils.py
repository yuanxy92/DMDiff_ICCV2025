...
def parse_args_paired_training(input_args=None):
   ...
   """
    ...
    parser.add_argument("--inject_scale", default=1.05, type=int)
...
class PairedDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return_d = {'gt': img_gt, 'kernel1': kernel, 'kernel2': kernel2, 'sinc_kernel': sinc_kernel, 'gt_path': gt_path,'lr': img_lr,'lr_path': lr_path}
        return return_d
